...
<link rel="stylesheet" href="bootstrap1/css/1.css">
		...
		<div class="row">
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="product-image"> 
						<img src="hakImages/p4.png" class="img-responsive"> 
						<span class="tag2 hot">
							HOT
						</span> 
					</div>
...
<div class="col-xs-12 col-md-6">
	...
	<div class="prod-info-main prod-wrap clearfix">
		<div class="row">
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="product-image"> 
						<img src="hakImages/p1.png" alt="194x228" class="img-responsive"> 
						<span class="tag2 hot">
							HOT
						</span> 
					</div>
...
<!-- First product box start here-->
	<div class="prod-info-main prod-wrap clearfix">
		<div class="row">
				<div class="col-md-5 col-sm-12 col-xs-12">
					<div class="product-image"> 
						<img src="hakImages/p2.png" alt="194x228" class="img-responsive"> 
