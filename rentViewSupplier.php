...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="media">
					<h2 class="title1">Renting Products</h2>
				</div>
  ...
  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
    <span aria-hidden=\"true\">&times;</span>
						...
						<div class="row">
							...
							<div class="col-md-2">
								<a href="addRentProducts.php?id=<?php echo $id; ?>">
...
<?php 
  				...
  				$productPrice="";
  				$photo="";
  				$sql = "SELECT productId,productName,productPrice,description,photo FROM product where pendingStatus='True' and typeId=3 and cId=$id";
		...
		<div class=\"row\">
				...
				<div class=\"product-info smart-form\">
					<div class=\"row\">
						<div class=\"col-md-12\">
						<br>
                            <a href=\"rentProductDetail.php?pId=".$productId."&id=".$id."\" class=\"btn btn-info\">More info</a>
						</div>
						<div class=\"col-md-12\">
							<br>
							<a href=\"deleteProcess.php?pId=".$productId."&type=rent\" class=\"btn btn-danger\">Delete Product</a>
						</div>
					</div>
				</div>
			</div>
...
<?php 
  				...
  				$productPrice="";
  				$photo="";
  				$sql = "SELECT productId,productName,productPrice,description,photo FROM product where pendingStatus='False' and typeId=3 and cId=$id";
			              $result = mysqli_query($db,$sql);
			              if (mysqli_num_rows($result) > 0) {
			                  // output data of each row
			                  while($row = mysqli_fetch_assoc($result)) {
		...
		<div class=\"row\">
				...
				<div class=\"product-info smart-form\">
					<div class=\"row\">
						<div class=\"col-md-12\">
						<br>
                            <a href=\"rentProductDetail.php?pId=".$productId."\" class=\"btn btn-info\">More info</a>
						</div>
						<div class=\"col-md-12\">
							<br>
							<a href=\"deleteProcess.php?pId=".$productId."&type=rent\" class=\"btn btn-danger\">Delete Product</a>
