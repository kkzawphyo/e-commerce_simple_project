...
<h1 style="font-family:Algerian;margin-left:2%;margin-top:1%;color:white">YCC Trading Center</h1>
    ...
    <form action='addSecondProcess.php?id=<?php echo $id; ?>' enctype='multipart/form-data' method='POST'>
<div id="frame" class="container"> 
	...
	<br>
      ...
      <?php      $category=array(1=>"Musical Instrument","Electronic Device","Vehicles","Furniture","Books"); ?>
      <div class="form-group row">
