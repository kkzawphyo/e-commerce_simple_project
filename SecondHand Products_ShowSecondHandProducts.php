<?php 
        ...
        while($row=mysqli_fetch_assoc($currentPageResult)){
            ...
            echo "<div class='grid_1_of_4 images_1_of_4'>
                    <div id='myDiv'>
                     <a href='ProductDetails_SecondHandProducts.php?cid=$cId&pid=$productId'>
    ...
    // START OF PAGINATION! 
        ...
        if($currentPageNumber>1){
            ...
            echo "<li><a href=\"SecondHand Products.php?currentPage=$temp&keyWord=$keyWord&category=$category\"> << Previous </a></li>";
        ...
        while($flag<=$PageNumber){
            if($flag==$currentPageNumber){
                ...
                echo "<li class=\"active\" ><a href=\"SecondHand Products.php?currentPage=$flag&keyWord=$keyWord&category=$category\"><font color='red'>$flag</font></a></li>";
            }
            else{
                
                echo "<li><a href=\"SecondHand Products.php?currentPage=$flag&keyWord=$keyWord&category=$category\"> $flag </a></li>";
            }
        $flag++;
        }
        ...
        if($currentPageNumber<$PageNumber){
            $temp=$currentPageNumber+1;
            echo "<li><a href=\"SecondHand Products.php?currentPage=$temp&keyWord=$keyWord&category=$category\">Next >></a></li>";
