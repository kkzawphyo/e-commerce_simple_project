  ...
  <div class="panel-body">
    <?php
       include("config.php");
          ...
          $photo2="";
          $productDate="";
          $sql = "SELECT productId,productName,productPrice,description,availableQty,color,model,brand,size,type,photo,photo1,photo2,productDate FROM product where pendingStatus='False' and typeId=1";
        ...
        <div class=\"row\">
          <div class=\"col-md-12\">
          <div class=\"pull-right\"><a href=\"ReviewTeamPanelSecondHand.php?pId=".$productId."&cancel=yes\"><button class=\"btn btn-danger btn-xs\">cancel</button></a><br><a href=\"ReviewTeamPanelSecondHand.php?pId=".$productId."&confirm=yes\"><button class=\"btn btn-primary btn-xs\" style=\"margin-top:7px;\">approve</button></a></div><span><strong>Product name: ".$productName."</strong></span><br><br><span><strong>Price: ".$productPrice."</strong></span><br><br>
