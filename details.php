	...
	<div class="header">
		...
		<div class="header_top">
			<div class="logo">
			  ...
			  <div class="cart">
			  	  <p><span><a href="index.html">Sell</a></span> and <span><a href="index.html">Rent</a></span> your products today.
			  </div>
	...
	<div class="header_bottom">
	     	<div class="menu">
	     		<ul>
			    	...
			    	<li class="active"><a href="SecondHand Products.html">Second-Hand Products</a></li>
			    	<li><a href="Rent Service.html">Rent Service</a></li>
			    	<div class="clear"></div>
     			</ul>
	     	</div>
		...
		<div class="container">
			<div class="col-md-4 single-left">
				<div class="flexslider">
					<ul class="slides">
						<li data-thumb="customerDesign/images/a.jpg">
							<div class="thumb-image"> <img src="customerDesign/images/a.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="customerDesign/images/b.jpg">
							 <div class="thumb-image"> <img src="customerDesign/images/b.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li>
						<li data-thumb="customerDesign/images/c.jpg">
						   <div class="thumb-image"> <img src="customerDesign/images/c.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
						</li> 
					</ul>
				</div>
				<!-- flexslider -->
