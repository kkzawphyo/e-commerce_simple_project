...
<h1 style="font-family:Algerian;margin-left:2%;margin-top:1%;color:white">YCC Trading Center</h1>
    ...
    <form action='addRentProcess.php?id=<?php echo $id; ?>' enctype='multipart/form-data' method='POST'>
<div id="frame" class="container"> 
	...
	<br>
      ...
      <?php      $category=array(12=>"Books","Motor Cycles"); ?>
      <div class="form-group row">
    ...
    <div id="responce"><br></div>
          <div class="row">
                 <div class="col-10"></div>
                    <div class="col-2"><button  class="btn btn-primary" type="submit" >POST</button></form>
                    </div>
              </div>   
         </div>
   </div> <br>
